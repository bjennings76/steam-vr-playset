...
namespace Editor.ImageEffects {
	...
	class VignetteAndChromaticAberrationEditor : UnityEditor.Editor {
		...
		public override void OnInspectorGUI() {
			...
			if (m_Blur.floatValue > 0.0f) { EditorGUILayout.Slider(m_BlurSpread, 0.0f, 1.0f, new GUIContent(" Blur Distance")); }
			...
			} else { EditorGUILayout.PropertyField(m_ChromaticAberration, new GUIContent(" Chromatic Aberration")); }
