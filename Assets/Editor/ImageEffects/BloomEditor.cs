...
namespace Editor.ImageEffects {
	...
	class BloomEditor : UnityEditor.Editor {
		...
		public override void OnInspectorGUI() {
			...
			if (1 == tweakMode.intValue) { EditorGUILayout.PropertyField(bloomThresholdColor, new GUIContent(" RGB Threshold")); }
			EditorGUILayout.Separator();
			...
			if (1 == tweakMode.intValue) {
				...
				if (0 != tweakMode.intValue) { EditorGUILayout.PropertyField(lensflareMode, new GUIContent("Lens Flares")); } else { lensflareMode.enumValueIndex = 0; }
