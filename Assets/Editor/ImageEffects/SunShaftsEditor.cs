...
namespace Editor.ImageEffects {
	...
	class SunShaftsEditor : UnityEditor.Editor {
		...
		public override void OnInspectorGUI() {
			...
			if ((target as SunShafts).GetComponent<Camera>()) { GUILayout.Label("Current camera mode: " + (target as SunShafts).GetComponent<Camera>().depthTextureMode, EditorStyles.miniBoldLabel); }
