...
namespace SteamVR.Editor {
...
#endif
#if (UNITY_5_3 || UNITY_5_2 || UNITY_5_1 || UNITY_5_0)
									(!EditorPrefs.HasKey(ignore + stereoscopicRendering) && PlayerSettings.stereoscopic3D != recommended_StereoscopicRendering) ||
#endif
#if (UNITY_5_3 || UNITY_5_2 || UNITY_5_1)
									(!EditorPrefs.HasKey(ignore + virtualRealitySupported) && PlayerSettings.virtualRealitySupported != recommended_VirtualRealitySupported) ||
#endif
									forceShow;
	...
	// Switch to native OpenVR support.
		...
		var logo = Resources.LoadAssetAtPath<Texture2D>(resourcePath + "logo.png");
			...
			if (!EditorPrefs.HasKey(ignore + buildTarget) && EditorUserBuildSettings.activeBuildTarget != recommended_BuildTarget) {
				++numItems;
				...
				if (GUILayout.Button(string.Format(useRecommended, recommended_BuildTarget))) { EditorUserBuildSettings.SwitchActiveBuildTarget(recommended_BuildTarget); }
			...
			if (!EditorPrefs.HasKey(ignore + showUnitySplashScreen) && PlayerSettings.showUnitySplashScreen != recommended_ShowUnitySplashScreen) {
				++numItems;
			...
			if (!EditorPrefs.HasKey(ignore + defaultIsFullScreen) && PlayerSettings.defaultIsFullScreen != recommended_DefaultIsFullScreen) {
				++numItems;
			...
			if (!EditorPrefs.HasKey(ignore + defaultScreenSize) && (PlayerSettings.defaultScreenWidth != recommended_DefaultScreenWidth || PlayerSettings.defaultScreenHeight != recommended_DefaultScreenHeight)) {
				++numItems;
			...
			if (!EditorPrefs.HasKey(ignore + runInBackground) && PlayerSettings.runInBackground != recommended_RunInBackground) {
				++numItems;
			...
			if (!EditorPrefs.HasKey(ignore + resizableWindow) && PlayerSettings.resizableWindow != recommended_ResizableWindow) {
				++numItems;
			...
			if (!EditorPrefs.HasKey(ignore + fullscreenMode) && PlayerSettings.d3d11FullscreenMode != recommended_FullscreenMode) {
				++numItems;
				...
				if (GUILayout.Button(string.Format(useRecommended, recommended_FullscreenMode))) { PlayerSettings.d3d11FullscreenMode = recommended_FullscreenMode; }
			...
			if (!EditorPrefs.HasKey(ignore + visibleInBackground) && PlayerSettings.visibleInBackground != recommended_VisibleInBackground) {
				++numItems;
			...
			if (!EditorPrefs.HasKey(ignore + renderingPath) && PlayerSettings.renderingPath != recommended_RenderPath) {
				++numItems;
			...
			PlayerSettings.singlePassStereoRendering != recommended_SinglePassStereoRendering)
		{
...
#endif
#if (UNITY_5_3 || UNITY_5_2 || UNITY_5_1 || UNITY_5_0)
			if (!EditorPrefs.HasKey(ignore + stereoscopicRendering) && PlayerSettings.stereoscopic3D != recommended_StereoscopicRendering) {
				++numItems;
				...
				if (GUILayout.Button(string.Format(useRecommended, recommended_StereoscopicRendering))) { PlayerSettings.stereoscopic3D = recommended_StereoscopicRendering; }

				GUILayout.FlexibleSpace();

				if (GUILayout.Button("Ignore")) { EditorPrefs.SetBool(ignore + stereoscopicRendering, true); }

				GUILayout.EndHorizontal();
			}
#endif
#if (UNITY_5_3 || UNITY_5_2 || UNITY_5_1)
			if (!EditorPrefs.HasKey(ignore + virtualRealitySupported) && PlayerSettings.virtualRealitySupported != recommended_VirtualRealitySupported) {
				++numItems;
				...
				if (GUILayout.Button(string.Format(useRecommended, recommended_VirtualRealitySupported))) { PlayerSettings.virtualRealitySupported = recommended_VirtualRealitySupported; }

				GUILayout.FlexibleSpace();

				if (GUILayout.Button("Ignore")) { EditorPrefs.SetBool(ignore + virtualRealitySupported, true); }
			...
			if (numItems > 0) {
				if (GUILayout.Button("Accept All")) {
					...
					if (!EditorPrefs.HasKey(ignore + buildTarget)) { EditorUserBuildSettings.SwitchActiveBuildTarget(recommended_BuildTarget); }
					if (!EditorPrefs.HasKey(ignore + showUnitySplashScreen)) { PlayerSettings.showUnitySplashScreen = recommended_ShowUnitySplashScreen; }
					if (!EditorPrefs.HasKey(ignore + defaultIsFullScreen)) { PlayerSettings.defaultIsFullScreen = recommended_DefaultIsFullScreen; }
				...
				if (GUILayout.Button("Ignore All")) {
					if (EditorUtility.DisplayDialog("Ignore All", "Are you sure?", "Yes, Ignore All", "Cancel")) {
						...
						if (EditorUserBuildSettings.activeBuildTarget != recommended_BuildTarget) { EditorPrefs.SetBool(ignore + buildTarget, true); }
						if (PlayerSettings.showUnitySplashScreen != recommended_ShowUnitySplashScreen) { EditorPrefs.SetBool(ignore + showUnitySplashScreen, true); }
						if (PlayerSettings.defaultIsFullScreen != recommended_DefaultIsFullScreen) { EditorPrefs.SetBool(ignore + defaultIsFullScreen, true); }
						if (PlayerSettings.defaultScreenWidth != recommended_DefaultScreenWidth || PlayerSettings.defaultScreenHeight != recommended_DefaultScreenHeight) { EditorPrefs.SetBool(ignore + defaultScreenSize, true); }
						if (PlayerSettings.runInBackground != recommended_RunInBackground) { EditorPrefs.SetBool(ignore + runInBackground, true); }
						if (PlayerSettings.displayResolutionDialog != recommended_DisplayResolutionDialog) { EditorPrefs.SetBool(ignore + displayResolutionDialog, true); }
						if (PlayerSettings.resizableWindow != recommended_ResizableWindow) { EditorPrefs.SetBool(ignore + resizableWindow, true); }
						if (PlayerSettings.d3d11FullscreenMode != recommended_FullscreenMode) { EditorPrefs.SetBool(ignore + fullscreenMode, true); }
						if (PlayerSettings.visibleInBackground != recommended_VisibleInBackground) { EditorPrefs.SetBool(ignore + visibleInBackground, true); }
						if (PlayerSettings.renderingPath != recommended_RenderPath) { EditorPrefs.SetBool(ignore + renderingPath, true); }
						if (PlayerSettings.colorSpace != recommended_ColorSpace) { EditorPrefs.SetBool(ignore + colorSpace, true); }
#if !(UNITY_5_3 || UNITY_5_2 || UNITY_5_1 || UNITY_5_0)
...
#endif
#if (UNITY_5_3 || UNITY_5_2 || UNITY_5_1 || UNITY_5_0)
						if (PlayerSettings.stereoscopic3D != recommended_StereoscopicRendering) { EditorPrefs.SetBool(ignore + stereoscopicRendering, true); }
#endif
#if (UNITY_5_3 || UNITY_5_2 || UNITY_5_1)
						if (PlayerSettings.virtualRealitySupported != recommended_VirtualRealitySupported) { EditorPrefs.SetBool(ignore + virtualRealitySupported, true); }
#endif
						Close();
					}
				}
