...
namespace SteamVR.Scripts {
	public class SteamVR_IK : MonoBehaviour {
		...
		void LateUpdate() {
			...
			Solve(start.position, targetPosition, poleVector.position, (joint.position - start.position).magnitude, (end.position - joint.position).magnitude, ref result, out forward, out up);
