...
namespace SteamVR.Scripts {
	public class SteamVR_TestController : MonoBehaviour {
		readonly List<int> controllerIndices = new List<int>();
		...
		void OnEnable() { SteamVR_Utils.Event.Listen("device_connected", OnDeviceConnected); }

		void OnDisable() { SteamVR_Utils.Event.Remove("device_connected", OnDeviceConnected); }
		...
		readonly EVRButtonId[] buttonIds = {EVRButtonId.k_EButton_ApplicationMenu, EVRButtonId.k_EButton_Grip, EVRButtonId.k_EButton_SteamVR_Touchpad, EVRButtonId.k_EButton_SteamVR_Trigger};

		readonly EVRButtonId[] axisIds = {EVRButtonId.k_EButton_SteamVR_Touchpad, EVRButtonId.k_EButton_SteamVR_Trigger};
