...
namespace SteamVR.Scripts {
	...
	public class SteamVR_Ears : MonoBehaviour {
		...
		void OnEnable() {
			...
			if (usingSpeakers) { SteamVR_Utils.Event.Listen("new_poses_applied", OnNewPosesApplied); }
		}

		void OnDisable() { if (usingSpeakers) { SteamVR_Utils.Event.Remove("new_poses_applied", OnNewPosesApplied); } }
	}
}