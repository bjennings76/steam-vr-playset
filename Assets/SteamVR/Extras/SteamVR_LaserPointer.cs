...
namespace SteamVR.Extras {
	...
	public class SteamVR_LaserPointer : MonoBehaviour {
		...
		void Start() {
			...
			} else { if (collider) { Destroy(collider); } }
		...
		void Update() {
			...
			if (controller != null && controller.triggerPressed) { pointer.transform.localScale = new Vector3(thickness*5f, thickness*5f, dist); } else { pointer.transform.localScale = new Vector3(thickness, thickness, dist); }
