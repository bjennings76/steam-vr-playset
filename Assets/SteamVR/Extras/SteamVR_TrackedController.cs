	...
	public class SteamVR_TrackedController : MonoBehaviour {
		...
		void Start() {
			...
			if (controllerIndex != 0) {
				...
				if (GetComponent<SteamVR_RenderModel>() != null) { GetComponent<SteamVR_RenderModel>().index = (SteamVR_TrackedObject.EIndex) controllerIndex; }
			} else { controllerIndex = (uint) GetComponent<SteamVR_TrackedObject>().index; }
		}

		public void SetDeviceIndex(int index) { controllerIndex = (uint) index; }

		public virtual void OnTriggerClicked(ClickedEventArgs e) { if (TriggerClicked != null) { TriggerClicked(this, e); } }

		public virtual void OnTriggerUnclicked(ClickedEventArgs e) { if (TriggerUnclicked != null) { TriggerUnclicked(this, e); } }

		public virtual void OnMenuClicked(ClickedEventArgs e) { if (MenuButtonClicked != null) { MenuButtonClicked(this, e); } }
		...
		public virtual void OnPadClicked(ClickedEventArgs e) { if (PadClicked != null) { PadClicked(this, e); } }

		public virtual void OnPadUnclicked(ClickedEventArgs e) { if (PadUnclicked != null) { PadUnclicked(this, e); } }

		public virtual void OnPadTouched(ClickedEventArgs e) { if (PadTouched != null) { PadTouched(this, e); } }

		public virtual void OnPadUntouched(ClickedEventArgs e) { if (PadUntouched != null) { PadUntouched(this, e); } }
